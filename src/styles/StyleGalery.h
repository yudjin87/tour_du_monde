...
#include <styles/IStyleGalery.h>

class StyleGalery : public IStyleGalery
{
    Q_OBJECT
public:
    StyleGalery();
...
private:
    ILayerStyleCollectionUPtr m_styles;
};

typedef std::unique_ptr<StyleGalery> StyleGaleryUPtr;
