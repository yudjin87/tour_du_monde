...
public:
     ...
     *   Use setupTourDeMonde() before, and resetTourDeMonde() after this method
     */
     ...
     */
    virtual void setupTourDeMonde(QPainter *painter) = 0;

    /*!
     * @details
     *   Restores painter to original state.
     */
    virtual void resetTourDeMonde(QPainter *painter) = 0;
