...
private Q_SLOTS:
    ...
    void shouldNotNotifyAboutFailedRemoving();
    ...
    void shouldNotifyAboutItemsChangedAfterSorting();
    void shouldNotifyAboutItemsChangedAfterSortingWithCustomPredicate();
